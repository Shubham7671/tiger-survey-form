            ...
            {!shouldPublish ? (
                <>
                    <div className="dropdown">
                        <div onClick={() => setOpen(!open)} className={`graydiv ui selection dropdown ${open ? 'visible active' : ''}`}>
                    ...
                    <div>
                        {selected !== "Select Question Type" ? (
                            <div>
                                <QuestionsAndAnswers selected={selected} setQuestions={setQuestionsHandler} />
                            </div>
                        ) : null}
                    </div>
                </>
