            ...
            {(questions.length > 0) ? (
                <div>
                    <form>
                                    ...
                                    <div style={{ float: "left", clear: "left" }} key={index}>
                                        <>
                                            ...
                                            {Object.keys(ques.question['answers']).map((key) => (
                                                <div key={key} style={{ float: "left", clear: "left", margin: "0px 0px 5px 0px" }} className="form-check">
                        ...
                        <button style={{ float: "right", clear: "left" }} onClick={confirmed} className="tiny ui button">Confirm</button>
                    </form>
                </div>
            ) : (
                <div>"Survey not available. Please create a survey first."
                    <button style={{ float: "right", clear: "left" }} onClick={confirmed} className="tiny ui button">Go Back</button>
                </div>
            )}
        </div>
    );
